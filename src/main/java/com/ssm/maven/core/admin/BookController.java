...
public class BookController {
     ...
     */
    @RequestMapping("/save")
    public String save(Book book, HttpServletResponse response)
            throws Exception {
        int resultTotal = 0;
        if (book.getId() == null) {
           resultTotal = bookService.insertBook(book);
        }else {
        ...
        log.info("request: book/save ,  " + book.toString());
        ResponseUtil.write(response, result);
        return null;
    }
    ...
    public String delete(@RequestParam(value = "ids") String ids,
        ...
        result.put("success", true);
        log.info("request: book/delete , ids: " + ids);
        ResponseUtil.write(response, result);
        return null;
    }
